...
import uvicorn
from app.controlador.PatientCrud import GetPatientById,WritePatient,GetPatientByIdentifier,WriteCondition
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://hl7-patient-write-gabriela-787.onrender.com","https://condition-write-gabriela-787.onrender.com"],  # Permitir solo este dominio
